<div class="modal-content">
    ...
    <script type="text/javascript" src="{{ asset('/assets/custom/freezeAccount/agent/func_save.js?v=') }}@php echo date("H:i:s") @endphp"></script>
    <script src="{{ asset('assets/js/forms-extras.js') }}"></script>
    <script>
        // Initialize Select2 when the modal is shown
        $('#addFreezeAccountAgentModal').on('shown.bs.modal', function() {
            $('#bank_id').select2({
                placeholder: 'เลือกข้อมูล',
                allowClear: true, // Ensures the clear option is available
                dropdownParent: $(
                    '#addFreezeAccountAgentModal'), // Ensures dropdown appears within the modal
