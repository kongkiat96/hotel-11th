$(document).ready(function () {
    $("#saveEditFreezeDepartment").on("click", function (e) {
        e.preventDefault();
        ...
        fv.validate().then(function (status) {
            if (status === 'Valid') {
                postFormData("/freeze-account/department/edit-freezeAccount-department/" + freezeID, formData)
...
function onSaveEditFreezeSuccess(response) {
    ...
    closeAndResetModal("#editFreezeAccountDepartmentModal", "#formEditFreezeAccount");
}