<div class="modal-content">
        ...
        <form id="formEditRentAccount" class="form-block">
            ...
            <div class="row g-2">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" id="rent_total" name="rent_total" class="form-control numeral-mask" placeholder="ระบุจำนวนบัญชี" value="{{ $dataRentAccount->rent_total }}"/>
                </div>
    ...
    <div class="modal-footer">
        ...
        <button type="submit" name="saveEditRentAccount" id="saveEditRentAccount"
            class="btn btn-warning btn-form-block-overlay"><i class='menu-icon tf-icons bx bxs-save'></i>
            บันทึกข้อมูล</button>
    </div>

    <script type="text/javascript"
        src="{{ asset('/assets/custom/rentAccount/func_edit.js?v=') }}@php echo date("H:i:s") @endphp"></script>
    <script src="{{ asset('assets/js/forms-extras.js') }}"></script>
    <script>
        var datePickers = ['edit_date_request_rent', 'edit_date_sent'];
