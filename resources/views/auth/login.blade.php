...
<head>
    ...
    <title>Login {{ config('aboutApp.show_app_name') }} </title>
                        ...
                        <div class="app-brand justify-content-center mb-0">
                            <a href="#" class="app-brand-link gap-2">
                                <span class="app-brand-logo demo">
                                    <img src="{{ asset('storage/public/uploads/aboutApp/' . config('aboutApp.about_app_img')) }}"
                                    alt="app image" width="100px" height="100px">
                                </span>
                            </a>
                        </div>
                        <!-- /Logo -->
...
<div class="col-12 text-center mt-2">
    <h5 class="mb-2">{{ config('aboutApp.show_app_name') }}</h5>
