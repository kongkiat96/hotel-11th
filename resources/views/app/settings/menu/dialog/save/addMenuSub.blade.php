<div class="modal-content">
    ...
    <hr>
    <form id="formAddMenuSub" class="form-block">
            ...
            <div class="row g-2">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="pathMenu" class="form-control" name="pathMenu"
                        autocomplete="off" placeholder="(Route::get), Ex : settings-system"/>
                </div>
        ...
        <div class="modal-footer">
            ...
            <button type="submit" name="saveMenuSub" id="saveMenuSub" class="btn btn-success btn-form-block-overlay"><i
