<div class="modal-content">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        <input type="text" id="amount_total" name="amount_total"
                            ...
                            value="{{ number_format($dataFreezeAccount->amount_total, 2) }}"/>
    ...
    <script>
        ...
        $('#viewFreezeAccountDepartmentModal').on('shown.bs.modal', function() {
            $('#bank_id').select2({
                placeholder: 'เลือกข้อมูล',
                allowClear: true, // Ensures the clear option is available
                dropdownParent: $(
                    '#viewFreezeAccountDepartmentModal'), // Ensures dropdown appears within the modal
