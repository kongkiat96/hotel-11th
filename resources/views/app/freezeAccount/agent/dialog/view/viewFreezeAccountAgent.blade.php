<div class="modal-content">
    <div class="modal-header">
        <h5 class="modal-title">ตรวจสอบข้อมูลรายการข้อมูลบัญชีที่อายัดในระบบ</h5>
        ...
        <form id="formEditFreezeAccount" class="form-block">
            ...
            <div class="row g-2">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" id="machine_name" class="form-control" name="machine_name" autocomplete="off"
                        value="{{ $dataFreezeAccount->machine_name }}" />
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        <input type="text" id="amount_total" name="amount_total" class="form-control numeral-mask"
                            placeholder="ระบุจำนวนเงิน" value="{{ number_format($dataFreezeAccount->amount_total,2) }}" />
    ...
    <script>
        ...
        $('#viewFreezeAccountAgentModal').on('shown.bs.modal', function() {
            $('#bank_id').select2({
                placeholder: 'เลือกข้อมูล',
                allowClear: true, // Ensures the clear option is available
                dropdownParent: $(
                    '#viewFreezeAccountAgentModal'), // Ensures dropdown appears within the modal
